...
<style>
/* Mentor admins — modern layout (scoped) */
.mu-page { max-width: 1440px; margin: 0 auto; padding: 0 2px 2.5rem; }
.mu-hero {
    position: relative;
    border-radius: 20px;
    overflow: hidden;
...
.mu-hero::before {
    ...
    position: absolute;
    inset: 0;
    background: radial-gradient(ellipse 80% 60% at 90% 20%, rgba(99, 102, 241, 0.14), transparent 55%),
...
.mu-back:hover { color: #a5b4fc !important; }
...
<?php if(!isset($_GET['user'])){ ?>
	...
	<div class="mu-hero">
		<div class="mu-hero-inner">
			...
			<h1 class="mu-title">Mentor admins</h1>
			<p class="mu-lead">Search by name, email, phone, or ID. Open a mentor to see their expert advisors. Trusted staff can adjust key limits and account status.</p>
		</div>
	</div>
...
?>
	...
	<div class="mu-hero" style="margin-bottom:1.25rem;">
		<div class="mu-hero-inner">
			...
			<p class="mu-lead">Expert advisors and licence codes for this account.</p>
		</div>
	</div>
