...
.profile-fb-avatar-ring {
    ...
    border-radius: 50%;
    padding: 4px;
    background: linear-gradient(135deg, #3699ff, #7c3aed, #1bc5bd);
...
.profile-card-icon.details {
    background: linear-gradient(135deg, rgba(154, 85, 255, 0.2), rgba(124, 58, 237, 0.05));
    color: #a78bfa;
}
...
<div class="profile-page">
    <div class="row mb-4">
        <div class="col-12">
            <h2 class="dashboard-title" style="margin-bottom: 4px;">Account settings</h2>
            <p class="dashboard-subtitle" style="color: rgba(255,255,255,0.5);">Manage your profile, photo, and sign-in details</p>
        </div>
    </div>
