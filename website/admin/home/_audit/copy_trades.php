...
<style>
.copy-trades-container { padding: 4px 2px 2rem; max-width: 1200px; animation: acSoftIn .55s cubic-bezier(.22,1,.36,1) both; }
.signal-card {
  background: linear-gradient(180deg, #0b1a2b, #07131f);
  border-radius: 22px;
...
.signal-card:hover { transform: translateY(-2px); box-shadow: 0 24px 56px rgba(0,0,0,0.34); }
.form-row-flex { display: flex; gap: 16px; align-items: flex-end; flex-wrap: wrap; }
...
.lot-martingale-field { flex: 0 0 160px; border: 1px solid rgba(255, 193, 7, 0.35); border-radius: 14px; padding: 12px; background: rgba(255, 193, 7, 0.08); }
.form-col label { display: block; margin-bottom: 8px; font-weight: 600; font-size: 13px; color: rgba(255,255,255,0.9); }
.form-col select, .form-col input {
  width: 100%; padding: 12px 14px; border-radius: 14px;
  border: 1px solid rgba(255,255,255,0.1); background: rgba(0,0,0,0.2); color: #fff; font-size: 14px;
  transition: border-color .3s ease, box-shadow .3s ease;
}
.form-col select:focus, .form-col input:focus { outline: none; border-color: #00e5ff; box-shadow: 0 0 0 4px rgba(0,229,255,.12); }
.btn-create {
  padding: 12px 28px; border: none; border-radius: 14px; cursor: pointer; white-space: nowrap;
  background: linear-gradient(135deg, #5ef6ff 0%, #00b8d4 100%); color: #021018; font-weight: 700; font-size: 14px;
  transition: transform .3s cubic-bezier(.22,1,.36,1), box-shadow .3s ease;
}
.btn-create:hover { transform: translateY(-2px); box-shadow: 0 12px 28px rgba(0,229,255,0.28); }
.signals-section { margin-top: 32px; padding-top: 24px; border-top: 1px solid rgba(0,229,255,0.12); }
.signals-header { margin-bottom: 16px; }
.signals-header h5 { margin: 0; font-size: 1rem; font-weight: 600; color: rgba(255,255,255,0.9); }
.signals-table { width: 100%; overflow-x: auto; border-radius: 16px; background: rgba(0,0,0,0.2); }
.signals-table table { width: 100%; border-collapse: collapse; }
.signals-table th {
  background: rgba(0,0,0,0.35); padding: 12px 16px; text-align: left; font-weight: 700;
  font-size: 11px; color: rgba(255,255,255,0.55); text-transform: uppercase; letter-spacing: 0.5px;
}
.signals-table td { padding: 14px 16px; border-bottom: 1px solid rgba(255,255,255,0.04); font-size: 13px; vertical-align: middle; }
.signals-table tbody tr { transition: background .25s ease; }
.signals-table tbody tr:last-child td { border-bottom: none; }
.signals-table tbody tr:hover td { background: rgba(0,229,255,0.05); }
.signals-table .ea-name { font-weight: 600; color: rgba(255,255,255,0.95); }
.signals-table .col-tp { color: #34d399; font-weight: 600; }
.signals-table .col-sl { color: #fb7185; font-weight: 600; }
.signals-table .col-date { color: rgba(255,255,255,0.5); font-size: 12px; }
.signals-empty { background: rgba(0,0,0,0.2) !important; }
.badge-symbol { background: rgba(0,229,255,.18); color: #67e8f9; padding: 5px 12px; border-radius: 999px; font-size: 12px; font-weight: 600; display: inline-block; }
.badge-buy { background: rgba(52,211,153,.18); color: #86efac; padding: 5px 12px; border-radius: 999px; font-size: 12px; font-weight: 600; display: inline-block; }
.badge-sell { background: rgba(251,113,133,.18); color: #fda4af; padding: 5px 12px; border-radius: 999px; font-size: 12px; font-weight: 600; display: inline-block; }
.badge-active { background: rgba(52,211,153,0.18); color: #86efac; padding: 5px 12px; border-radius: 999px; font-size: 12px; font-weight: 600; display: inline-block; }
.badge-result-closed { background: rgba(255,255,255,0.08); color: rgba(255,255,255,0.65); padding: 5px 12px; border-radius: 999px; font-size: 11px; font-weight: 600; display: inline-block; text-transform: capitalize; }
.badge-result-other { background: rgba(0,229,255,0.18); color: #a5f3fc; padding: 5px 12px; border-radius: 999px; font-size: 11px; font-weight: 600; display: inline-block; text-transform: capitalize; }
.btn-close-signal {
  background: linear-gradient(135deg,#fb7185,#e11d48); border: none; color: #fff; padding: 6px 16px;
  border-radius: 10px; font-size: 12px; font-weight: 600; cursor: pointer; transition: opacity .25s, transform .25s;
}
.btn-close-signal:hover { opacity: 0.92; transform: translateY(-1px); }
.header-flex { display: flex; justify-content: space-between; align-items: center; margin-bottom: 1.5rem; gap: 1rem; flex-wrap: wrap; }
.header-flex h3 { font-size: 1.7rem; font-weight: 800; letter-spacing: -.03em; margin: 0; font-family: Syne, system-ui, sans-serif; }
.live-badge {
  background: rgba(52,211,153,.12); border: 1px solid rgba(52,211,153,.3); color: #86efac;
  padding: 6px 16px; border-radius: 999px; font-size: 12px; font-weight: 700;
}
</style>

<div class="copy-trades-container aura-console-page">
        ...
        <div class="signal-card">
            <div class="header-flex">
                <h3 style="margin: 0;"><i class="ti ti-copy"></i> Signal sync</h3>
