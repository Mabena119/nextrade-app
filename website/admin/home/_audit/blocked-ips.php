...
.ip-btn-primary { background: linear-gradient(135deg,#5ef6ff,#00b8d4); color:#021018; transition: transform .3s ease, box-shadow .3s ease; } .ip-btn-primary:hover { transform: translateY(-1px); box-shadow: 0 10px 24px rgba(0,229,255,.25); }
...
.ip-current { font-family: ui-monospace, Menlo, Consolas, monospace; color: #67e8f9; }
</style>

<div class="ip-page ac-ops">
    <div class="ip-hero ac-ops-hero">
        <p class="ac-ops-kicker">Access guard</p>
